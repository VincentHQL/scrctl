...
func newDevice(id string, conn *websocket.Conn, port int, privateData interface{}) *Device {
...
func (d *Device) Send(msg interface{}) error {
	// return d.conn.WriteMessage(websocket.BinaryMessage, msg)
	return nil
}
...
func (p *DevicePool) Register(id string, conn *websocket.Conn, port int, privateData interface{}) *Device {
